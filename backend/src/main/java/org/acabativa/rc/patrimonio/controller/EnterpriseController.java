        ...
        try {
            ...
            if (documentFile != null && !documentFile.isEmpty()) {
                ...
                if (contentType != null && contentType.contains("pdf")) {
                    storageService.storeForEnterprise(documentFile, FileType.DOCUMENT, saved.getId());
                } else {
                    redirectAttributes.addFlashAttribute("warningMessage",
                        "Empreendimento criado, mas o arquivo não é um PDF válido.");
                }
            }
        ...
        try {
            ...
            if (documentFile != null && !documentFile.isEmpty()) {
                ...
                if (contentType != null && contentType.contains("pdf")) {
                    ...
                    redirectAttributes.addFlashAttribute("warningMessage",
                        "Empreendimento atualizado, mas o arquivo não é um PDF válido.");
                }
            }
